...
// TAREA: Función que identifica a los estudiantes que necesitan tutoría
...
// Función que lista a los estudiantes de honor
...
echo "Estudiantes que necesitan tutoría: " . implode(", ", $tutores) . "\n";

//Mostrar estudiantes de honor
$honor = estudiantesDeHonor($estudiantes);
echo "Estudiantes de honor: " . implode(", ", $honor) . "\n";
